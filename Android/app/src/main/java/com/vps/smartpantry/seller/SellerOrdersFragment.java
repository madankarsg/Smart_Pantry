...
public class SellerOrdersFragment extends Fragment {
        ...
        orders_rv.addOnItemTouchListener( new RecyclerItemClickListener(getContext(), orders_rv ,new RecyclerItemClickListener.OnItemClickListener()
                {
                    ...
                    public void onItemClick(View view, final int position)
                    {
                        ...
                        // set dialog message
                        alertDialogBuilder
                                .setMessage("What you want to do with this order")
                                .setCancelable(false)
    ...
    public void calibrateOrder(boolean cmd, final int pos)
    {
        ...
        if(cmd)
            mDialog.setMessage("Accepting order...");
        else
            mDialog.setMessage("Rejecting order...");
        mDialog.show();
        String url="";
        if(cmd)
            url = "http://" + Config.SERVER_ADDRESS + "/android/accept_order.php";
        else
            url= "http://" + Config.SERVER_ADDRESS + "/android/reject_order.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("seller_id", Config.ID);
    ...
    public void getOrders()
    {
        ...
        String url = "http://" + Config.SERVER_ADDRESS + "/android/seller_orders.php";
